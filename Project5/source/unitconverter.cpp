...
double UnitConverter::areaToSI(double A) {UnitConverter::makeSureInitialized(); return UnitConverter::ar0*A; }
double UnitConverter::areaFromSI(double A) {UnitConverter::makeSureInitialized(); return A/UnitConverter::ar0; }
